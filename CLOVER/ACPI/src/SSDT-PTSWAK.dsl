// Credit: RehabMan
// taken from: https://github.com/RehabMan/OS-X-Clover-Laptop-Config/commit/75a574b66585339f720edca2710a1267908ba489
//
// Changelog:
//   - removed references to RMCF & comment out branches to disable instead
//     * removed Shutdown fix
//     * removed XPEE/USB fix
//     * removed DPTS / PEG0 fix
//   - changed arg fix in _WAK to >4 based on FreeJHack suggestion
// ====
...
DefinitionBlock("", "SSDT", 2, "hack", "_PTSWAK", 0)
{
    ...
    External(_SB.PCI0.RP01.PEGP.XOFF, MethodObj)
