...
DefinitionBlock("", "SSDT", 2, "hack", "_RMDT", 0)
{
    ...
    Device(RMDT)
    {
        ...
        Method(DBG0, 0, Serialized)
        {
            \RMDT.P1("DBG1 calls XOSI")
            Local0 = \XOSI("Darwin")
            \RMDT.P2("DBG1 Darwin results:", Local0)
            
            Local0 = \XOSI("Windows 2012")
            \RMDT.P2("DBG1 Windows 2012 results:", Local0)
